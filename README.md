...
last activity is older than `--min-age` days (default 7), it checks
...
use. See the "Worktree 7-day rule" section of `CLAUDE.md`.
...
WORKTREE_APPROVED=1 ./scripts/worktree_hygiene.sh --execute --min-age 7  # apply
```
