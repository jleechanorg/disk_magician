...
# 5GiB-granularity ledger and 30-day memory catalog. Includes agent worktrees,
# tool session stores (.aside, .gemini, .codex), local model weights (.ollama),
# agent database state (.hermes), scratch (/private/tmp, /private/var/folders),
